...
SELECT 
    ...
    SUM(CASE WHEN TOTAL.P15 = 'VIP Müşteri' THEN 1 ELSE 0 END) AS total_vip_customer_count,
    ROUND(SUM(CASE WHEN TOTAL.P15 = 'VIP Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS total_vip_customer_pct,
    SUM(CASE WHEN TOTAL.P15 = 'Sadık Müşteri' THEN 1 ELSE 0 END) AS total_loyal_customer_count,
    ROUND(SUM(CASE WHEN TOTAL.P15 = 'Sadık Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS total_loyal_customer_pct,
    SUM(CASE WHEN TOTAL.P15 = 'Tek Seferlik Müşteri' THEN 1 ELSE 0 END) AS total_one_time_customer_count,
    ROUND(SUM(CASE WHEN TOTAL.P15 = 'Tek Seferlik Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS total_one_time_customer_pct,
    LAST_ONE_YEAR.churn_risk_customer_count AS total_churn_risk_customer_count, 
     -- Churned Customers
    (SUM(CASE WHEN TOTAL.P15 = 'Riskli Müşteri' THEN 1 ELSE 0 END) - LAST_ONE_YEAR.churn_risk_customer_count) AS total_churned_customer_count,
...
LEFT JOIN (
    SELECT 
        ...
        SUM(CASE WHEN P6 = 'markayla yeni temas eden' THEN 1 ELSE 0 END) AS new_customer_count,
        ROUND(SUM(CASE WHEN P6 = 'markayla yeni temas eden' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS new_customer_pct,
        SUM(CASE WHEN P6 = 'aktif müşteri' THEN 1 ELSE 0 END) AS active_customer_count,
        ROUND(SUM(CASE WHEN P6 = 'aktif müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS active_customer_pct,
        SUM(CASE WHEN P15 = 'Tek Seferlik Müşteri' THEN 1 ELSE 0 END) AS one_time_customer_count,
        ROUND(SUM(CASE WHEN P15 = 'Tek Seferlik Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS one_time_customer_pct,
        SUM(CASE WHEN P15 = 'VIP Müşteri' THEN 1 ELSE 0 END) AS vip_customer_count,
        ROUND(SUM(CASE WHEN P15 = 'VIP Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS vip_customer_pct,
        SUM(CASE WHEN P15 = 'Sadık Müşteri' THEN 1 ELSE 0 END) AS loyal_customer_count,
        ROUND(SUM(CASE WHEN P15 = 'Sadık Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS loyal_customer_pct,
        SUM(CASE WHEN P15 = 'Potansiyel Büyüme Müşterisi' THEN 1 ELSE 0 END) AS potential_growth_customer_count,
        ROUND(SUM(CASE WHEN P15 = 'Potansiyel Büyüme Müşterisi' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS potential_growth_customer_pct,
        SUM(CASE WHEN P6 = 'aktif - riskli' THEN 1 ELSE 0 END) AS at_risk_customer_count,
        ROUND(SUM(CASE WHEN P6 = 'aktif - riskli' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS at_risk_customer_pct,
        SUM(CASE WHEN P15 = 'Riskli Müşteri' THEN 1 ELSE 0 END) AS churn_risk_customer_count,
        ROUND(SUM(CASE WHEN P15 = 'Riskli Müşteri' THEN 1 ELSE 0 END) * 100.0 / NULLIF(COUNT(*), 0), 1) AS churn_risk_customer_pct
